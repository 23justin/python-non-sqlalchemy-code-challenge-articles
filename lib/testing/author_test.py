...
class TestAuthor:
    ...
    def test_name_is_immutable_string(self):
        ...
        # Attempt to change author names
    ...
    def test_add_article(self):
        """Test if adding an article returns a new article given a magazine and title"""
        author_1 = Author("Carry Bradshaw")
        magazine_1 = Magazine("Vogue", "Fashion")
        magazine_2 = Magazine("AD", "Architecture")
    ...
    def test_topic_areas(self):
        """Test if topic areas are returned for all articles by the author"""
        author_1 = Author("Carry Bradshaw")
        author_2 = Author("Nathaniel Hawthorne")
        magazine_1 = Magazine("Vogue", "Fashion")
        magazine_2 = Magazine("AD", "Architecture")
