...
class TestMagazine:
    ...
    def test_has_name(self):
        """Test if Magazine is initialized with a name"""
    ...
    def test_name_is_mutable_string(self):
        """Test if magazine name is of type str and can change"""
        magazine_1 = Magazine("Vogue", "Fashion")
        magazine_2 = Magazine("AD", "Architecture")
    ...
    def test_name_len(self):
        """Test if magazine name has length between 2 and 16 characters"""
        magazine_1 = Magazine("Vogue", "Fashion")
        magazine_2 = Magazine("AD", "Architecture")
    ...
    def test_has_category(self):
        """Test if Magazine is initialized with a category"""
        magazine_1 = Magazine("Vogue", "Fashion")
        magazine_2 = Magazine("AD", "Architecture")
    ...
    def test_category_is_mutable_string(self):
        """Test if magazine category is of type str and can change"""
        magazine_1 = Magazine("Vogue", "Fashion")
        magazine_2 = Magazine("AD", "Architecture")
    ...
    def test_category_len(self):
        """Test if magazine category has length greater than 0"""
        magazine_1 = Magazine("Vogue", "Fashion")
    ...
    def test_has_many_articles(self):
        """Test if magazine has many articles"""
    ...
    def test_articles_of_type_articles(self):
        """Test if magazine articles are of type Article"""
        author_1 = Author("Carry Bradshaw")
        magazine_1 = Magazine("Vogue", "Fashion")
        magazine_2 = Magazine("AD", "Architecture")
    ...
    def test_has_many_contributors(self):
        """Test if magazine has many contributors"""
        author_1 = Author("Carry Bradshaw")
    ...
    def test_contributors_of_type_author(self):
        """Test if magazine contributors are of type Author"""
        author_1 = Author("Carry Bradshaw")
        author_2 = Author("Nathaniel Hawthorne")
        magazine_1 = Magazine("Vogue", "Fashion")
        Article(author_1, magazine_1, "How to wear a tutu with style")
    ...
    def test_contributors_are_unique(self):
        """Test if magazine contributors are unique"""
        author_1 = Author("Carry Bradshaw")
        author_2 = Author("Nathaniel Hawthorne")
        magazine_1 = Magazine("Vogue", "Fashion")
        Article(author_1, magazine_1, "How to wear a tutu with style")
    ...
    def test_article_titles(self):
        """Test if magazine returns a list of titles of all articles written for that magazine"""
        author_1 = Author("Carry Bradshaw")
        magazine_1 = Magazine("Vogue", "Fashion")
        magazine_2 = Magazine("AD", "Architecture")
    ...
    def test_contributing_authors(self):
        """Test if magazine returns a list of authors who have written more than 2 articles for"""
